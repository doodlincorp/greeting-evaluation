...
dependencies {
    ...
    implementation(project(":concept-adaptor-kafka"))
    implementation(project(":concept-adaptor-mysql"))
    implementation(project(":concept-adaptor-mongo"))
    implementation(project(":concept-adaptor-redis"))
    implementation(project(":concept-adaptor-aws"))
